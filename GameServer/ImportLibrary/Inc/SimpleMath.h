...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Vector2 : public XMFLOAT2
        {
            ...
            static void BaseData(const Vector2& v, const Quaternion& quat, Vector2& result) noexcept;
            static Vector2 BaseData(const Vector2& v, const Quaternion& quat) noexcept;

            static void BaseData(const Vector2& v, const Matrix& m, Vector2& result) noexcept;
            static Vector2 BaseData(const Vector2& v, const Matrix& m) noexcept;
            static void BaseData(_In_reads_(count) const Vector2* varray, size_t count, const Matrix& m, _Out_writes_(count) Vector2* resultArray) noexcept;

            static void BaseData(const Vector2& v, const Matrix& m, Vector4& result) noexcept;
            static void BaseData(_In_reads_(count) const Vector2* varray, size_t count, const Matrix& m, _Out_writes_(count) Vector4* resultArray) noexcept;
        ...
        struct Vector3 : public XMFLOAT3
        {
            ...
            static void BaseData(const Vector3& v, const Quaternion& quat, Vector3& result) noexcept;
            static Vector3 BaseData(const Vector3& v, const Quaternion& quat) noexcept;

            static void BaseData(const Vector3& v, const Matrix& m, Vector3& result) noexcept;
            static Vector3 BaseData(const Vector3& v, const Matrix& m) noexcept;
            static void BaseData(_In_reads_(count) const Vector3* varray, size_t count, const Matrix& m, _Out_writes_(count) Vector3* resultArray) noexcept;

            static void BaseData(const Vector3& v, const Matrix& m, Vector4& result) noexcept;
            static void BaseData(_In_reads_(count) const Vector3* varray, size_t count, const Matrix& m, _Out_writes_(count) Vector4* resultArray) noexcept;
        ...
        struct Vector4 : public XMFLOAT4
        {
            ...
            static void BaseData(const Vector2& v, const Quaternion& quat, Vector4& result) noexcept;
            static Vector4 BaseData(const Vector2& v, const Quaternion& quat) noexcept;

            static void BaseData(const Vector3& v, const Quaternion& quat, Vector4& result) noexcept;
            static Vector4 BaseData(const Vector3& v, const Quaternion& quat) noexcept;

            static void BaseData(const Vector4& v, const Quaternion& quat, Vector4& result) noexcept;
            static Vector4 BaseData(const Vector4& v, const Quaternion& quat) noexcept;

            static void BaseData(const Vector4& v, const Matrix& m, Vector4& result) noexcept;
            static Vector4 BaseData(const Vector4& v, const Matrix& m) noexcept;
            static void BaseData(_In_reads_(count) const Vector4* varray, size_t count, const Matrix& m, _Out_writes_(count) Vector4* resultArray) noexcept;
        ...
        struct Matrix : public XMFLOAT4X4
        {
            ...
            static void BaseData(const Matrix& M, const Quaternion& rotation, Matrix& result) noexcept;
            static Matrix BaseData(const Matrix& M, const Quaternion& rotation) noexcept;
        ...
        struct Plane : public XMFLOAT4
        {
            ...
            // Static functions
            static void BaseData(const Plane& plane, const Matrix& M, Plane& result) noexcept;
            static Plane BaseData(const Plane& plane, const Matrix& M) noexcept;

            static void BaseData(const Plane& plane, const Quaternion& rotation, Plane& result) noexcept;
            static Plane BaseData(const Plane& plane, const Quaternion& rotation) noexcept;
