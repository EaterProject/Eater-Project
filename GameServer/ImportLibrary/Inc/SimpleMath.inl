...
inline void Vector2::BaseData(const Vector2& v, const Quaternion& quat, Vector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
...
inline Vector2 Vector2::BaseData(const Vector2& v, const Quaternion& quat) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline void Vector2::BaseData(const Vector2& v, const Matrix& m, Vector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
...
inline Vector2 Vector2::BaseData(const Vector2& v, const Matrix& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::BaseData(const Vector2* varray, size_t count, const Matrix& m, Vector2* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector2::BaseData(const Vector2& v, const Matrix& m, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector2::BaseData(const Vector2* varray, size_t count, const Matrix& m, Vector4* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector3::BaseData(const Vector3& v, const Quaternion& quat, Vector3& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector3 Vector3::BaseData(const Vector3& v, const Quaternion& quat) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline void Vector3::BaseData(const Vector3& v, const Matrix& m, Vector3& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector3 Vector3::BaseData(const Vector3& v, const Matrix& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::BaseData(const Vector3* varray, size_t count, const Matrix& m, Vector3* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector3::BaseData(const Vector3& v, const Matrix& m, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector3::BaseData(const Vector3* varray, size_t count, const Matrix& m, Vector4* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Vector4::BaseData(const Vector2& v, const Quaternion& quat, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector4 Vector4::BaseData(const Vector2& v, const Quaternion& quat) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat2(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline void Vector4::BaseData(const Vector3& v, const Quaternion& quat, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector4 Vector4::BaseData(const Vector3& v, const Quaternion& quat) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat3(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline void Vector4::BaseData(const Vector4& v, const Quaternion& quat, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector4 Vector4::BaseData(const Vector4& v, const Quaternion& quat) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMVECTOR q = XMLoadFloat4(&quat);
...
inline void Vector4::BaseData(const Vector4& v, const Matrix& m, Vector4& result) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector4 Vector4::BaseData(const Vector4& v, const Matrix& m) noexcept
{
    using namespace DirectX;
    XMVECTOR v1 = XMLoadFloat4(&v);
    XMMATRIX M = XMLoadFloat4x4(&m);
...
_Use_decl_annotations_
inline void Vector4::BaseData(const Vector4* varray, size_t count, const Matrix& m, Vector4* resultArray) noexcept
{
    using namespace DirectX;
    XMMATRIX M = XMLoadFloat4x4(&m);
...
inline void Matrix::BaseData(const Matrix& M, const Quaternion& rotation, Matrix& result) noexcept
{
    using namespace DirectX;
    XMVECTOR quatv = XMLoadFloat4(&rotation);
...
inline Matrix Matrix::BaseData(const Matrix& M, const Quaternion& rotation) noexcept
{
    using namespace DirectX;
    XMVECTOR quatv = XMLoadFloat4(&rotation);
...
inline void Plane::BaseData(const Plane& plane, const Matrix& M, Plane& result) noexcept
{
    using namespace DirectX;
...
inline Plane Plane::BaseData(const Plane& plane, const Matrix& M) noexcept
{
    using namespace DirectX;
    XMVECTOR p = XMLoadFloat4(&plane);
    XMMATRIX m0 = XMLoadFloat4x4(&M);
...
inline void Plane::BaseData(const Plane& plane, const Quaternion& rotation, Plane& result) noexcept
{
    using namespace DirectX;
    XMVECTOR p = XMLoadFloat4(&plane);
...
inline Plane Plane::BaseData(const Plane& plane, const Quaternion& rotation) noexcept
{
    using namespace DirectX;
    XMVECTOR p = XMLoadFloat4(&plane);
    XMVECTOR q = XMLoadFloat4(&rotation);
