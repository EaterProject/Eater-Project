...
void Picking_Pass::Create(int width, int height)
{
...
void Picking_Pass::Start(int width, int height)
{
	// Shader 설정..
...
void Picking_Pass::OnResize(int width, int height)
{
	m_ID_RTV = m_ID_RT->GetRTV()->Get();
	m_ID_Tex2D = m_ID_RT->GetTex2D()->Get();
...
void Picking_Pass::InstanceResize(size_t& renderMaxCount, size_t& unRenderMaxCount)
{
...
void Picking_Pass::Release()
{

}

void Picking_Pass::BeginRender()
{
...
void Picking_Pass::RenderUpdate(const InstanceRenderBuffer* instance, const RenderData* meshData)
{
...
void Picking_Pass::RenderUpdate(const InstanceRenderBuffer* instance, const std::vector<RenderData*>& meshlist)
{
...
void Picking_Pass::NoneMeshRenderUpdate(const std::vector<RenderData*>& meshlist)
{
	m_RenderCount = (int)meshlist.size();
...
UINT Picking_Pass::FindPick(int x, int y)
{
