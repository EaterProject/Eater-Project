...
void Bloom_Pass::Create(int width, int height)
{
...
void Bloom_Pass::Start(int width, int height)
{
	// Shader..
...
void Bloom_Pass::OnResize(int width, int height)
{
...
void Bloom_Pass::Release()
{

}

void Bloom_Pass::ApplyOption()
{
...
void Bloom_Pass::DownSampling(ID3D11RenderTargetView* rtv, ID3D11ShaderResourceView* originSRV, const SamplingData& downScreen)
{
	// 해당 DownSample Screen 설정..
...
void Bloom_Pass::UpSampling(ID3D11RenderTargetView* rtv, ID3D11ShaderResourceView* originSRV, ID3D11ShaderResourceView* downSRV, const SamplingData& downScreen)
{
...
void Bloom_Pass::GaussianBlur(ID3D11RenderTargetView* rtv[2], ID3D11ShaderResourceView* srv[2], const SamplingData& downScreen)
{
...
void Bloom_Pass::SetSamplingViewPort(const SamplingData& downScreen)
{
...
void Bloom_Pass::SetBlurViewPort(const SamplingData& downScreen)
{
