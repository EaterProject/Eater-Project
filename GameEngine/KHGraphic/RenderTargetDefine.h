...
RANDER_TARGET(RT_Luminance_Target1)
RANDER_TARGET(RT_Luminance_Target2)
RANDER_TARGET(RT_Luminance_Target3)
RANDER_TARGET(RT_Luminance_Target4)
RANDER_TARGET(RT_Luminance_Target5)
RANDER_TARGET(RT_Luminance_Target6)
